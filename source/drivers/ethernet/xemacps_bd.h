 ...
 */
typedef uint32_t XEmacPs_Bd[XEMACPS_BD_NUM_WORDS];
...
* @note
* C-style signature:
*    uint32_t XEmacPs_BdRead(uint64_t BaseAddress, uint64_t Offset)
*
*****************************************************************************/
#define XEmacPs_BdRead(BaseAddress, Offset)             \
	(*(uint32_t *)((uint64_t)((void*)(BaseAddress)) + (uint32_t)(Offset)))
...
* @note
* C-style signature:
*    void XEmacPs_BdWrite(uint64_t BaseAddress, uint64_t Offset, uint64_t Data)
*
*****************************************************************************/
#define XEmacPs_BdWrite(BaseAddress, Offset, Data)              \
    (*(uint32_t *)((uint64_t)(void*)(BaseAddress) + (uint32_t)(Offset)) = (uint32_t)(Data))
 ...
 *
 * C-style signature:
 *    void XEmacPs_BdSetAddressTx(XEmacPs_Bd* BdPtr, uint64_t Addr)
 *
 *****************************************************************************/
#if defined(__aarch64__) || defined(__arch64__)
#define XEmacPs_BdSetAddressTx(BdPtr, Addr)                        \
    XEmacPs_BdWrite((BdPtr), XEMACPS_BD_ADDR_OFFSET,		\
			(uint32_t)((Addr) & ULONG64_LO_MASK));		\
    XEmacPs_BdWrite((BdPtr), XEMACPS_BD_ADDR_HI_OFFSET,		\
	(uint32_t)(((Addr) & ULONG64_HI_MASK) >> 32U));
#else
#define XEmacPs_BdSetAddressTx(BdPtr, Addr)                        \
    XEmacPs_BdWrite((BdPtr), XEMACPS_BD_ADDR_OFFSET, (uint32_t)(Addr))
#endif
 ...
 *
 * C-style signature:
 *    void XEmacPs_BdSetAddressRx(XEmacPs_Bd* BdPtr, uint64_t Addr)
 *
 *****************************************************************************/
#ifdef __aarch64__
#define XEmacPs_BdSetAddressRx(BdPtr, Addr)                        \
	...
	~XEMACPS_RXBUF_ADD_MASK) | ((uint32_t)((Addr) & ULONG64_LO_MASK))));  \
    XEmacPs_BdWrite((BdPtr), XEMACPS_BD_ADDR_HI_OFFSET, 	\
	(uint32_t)(((Addr) & ULONG64_HI_MASK) >> 32U));
#else
#define XEmacPs_BdSetAddressRx(BdPtr, Addr)                        \
    XEmacPs_BdWrite((BdPtr), XEMACPS_BD_ADDR_OFFSET,              \
    ((XEmacPs_BdRead((BdPtr), XEMACPS_BD_ADDR_OFFSET) &           \
    ~XEMACPS_RXBUF_ADD_MASK) | (uint64_t)(Addr)))
#endif
 ...
 * @note
 * C-style signature:
 *    void XEmacPs_BdSetStatus(XEmacPs_Bd* BdPtr, uint64_t Data)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint32_t XEmacPs_BdGetStatus(XEmacPs_Bd* BdPtr)
 *
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdGetBufAddr(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
#if defined(__aarch64__) || defined(__arch64__)
 ...
 * @note
 * C-style signature:
 *    void XEmacPs_BdSetLength(XEmacPs_Bd* BdPtr, uint32_t LenBytes)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdGetLength(XEmacPs_Bd* BdPtr)
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_GetRxFrameSize(XEmacPs* InstancePtr, XEmacPs_Bd* BdPtr)
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsLast(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint8_t XEmacPs_BdIsRxWrap(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint8_t XEmacPs_BdGetTxWrap(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsRxNew(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsTxUsed(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsTxRetry(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsTxUrun(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsTxExh(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 *
 * C-style signature:
 *    uint64_t XEmacPs_BdSetTxNoCRC(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 *
 * C-style signature:
 *    uint64_t XEmacPs_BdClearTxNoCRC(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsRxBcast(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsRxMultiHash(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsRxUniHash(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsRxVlan(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsRxPri(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdIsRxCFI(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdGetRxEOF(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
 ...
 * @note
 * C-style signature:
 *    uint64_t XEmacPs_BdGetRxSOF(XEmacPs_Bd* BdPtr)
 *
 *****************************************************************************/
