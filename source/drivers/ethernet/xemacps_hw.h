...
#define XEMACPS_TXSR_ERROR_MASK      ((uint32_t)XEMACPS_TXSR_HRESPNOK_MASK | \
                                       (uint32_t)XEMACPS_TXSR_URUN_MASK | \
                                       (uint32_t)XEMACPS_TXSR_BUFEXH_MASK | \
                                       (uint32_t)XEMACPS_TXSR_RXOVR_MASK | \
                                       (uint32_t)XEMACPS_TXSR_FRAMERX_MASK | \
                                       (uint32_t)XEMACPS_TXSR_USEDREAD_MASK)
/*@}*/
...
#define XEMACPS_RXSR_ERROR_MASK      ((uint32_t)XEMACPS_RXSR_HRESPNOK_MASK | \
                                       (uint32_t)XEMACPS_RXSR_RXOVR_MASK | \
                                       (uint32_t)XEMACPS_RXSR_BUFFNA_MASK)
...
#define XEMACPS_INTQ1_IXR_ALL_MASK	((uint32_t)XEMACPS_INTQ1SR_TXCOMPL_MASK | \
					 (uint32_t)XEMACPS_INTQ1SR_TXERR_MASK)
...
#define XEMACPS_IXR_TX_ERR_MASK    ((uint32_t)XEMACPS_IXR_TXEXH_MASK |         \
                                     (uint32_t)XEMACPS_IXR_RETRY_MASK |         \
                                     (uint32_t)XEMACPS_IXR_URUN_MASK)


#define XEMACPS_IXR_RX_ERR_MASK    ((uint32_t)XEMACPS_IXR_HRESPNOK_MASK |      \
                                     (uint32_t)XEMACPS_IXR_RXUSED_MASK |        \
                                     (uint32_t)XEMACPS_IXR_RXOVR_MASK)
...
* @note
* C-style signature:
*    uint32_t XEmacPs_ReadReg(uint32_t BaseAddress, uint32_t RegOffset)
*
*****************************************************************************/
#define XEmacPs_ReadReg(BaseAddress, RegOffset) \
    XEmacPs_In32((BaseAddress) + (uint32_t)(RegOffset))
...
* @note
* C-style signature:
*    void XEmacPs_WriteReg(uint32_t BaseAddress, uint32_t RegOffset,
*         uint32_t Data)
*
*****************************************************************************/
#define XEmacPs_WriteReg(BaseAddress, RegOffset, Data) \
    XEmacPs_Out32((BaseAddress) + (uint32_t)(RegOffset), (uint32_t)(Data))

/************************** Function Prototypes *****************************/
/*
 * Perform reset operation to the emacps interface
 */
void XEmacPs_ResetHw(uint32_t BaseAddr);
