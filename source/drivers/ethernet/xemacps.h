...
#define XEMACPS_DEFAULT_OPTIONS                     \
	((uint32_t)XEMACPS_FLOW_CONTROL_OPTION |                  \
	 (uint32_t)XEMACPS_FCS_INSERT_OPTION |                    \
	 (uint32_t)XEMACPS_FCS_STRIP_OPTION |                     \
	 (uint32_t)XEMACPS_BROADCAST_OPTION |                     \
	 (uint32_t)XEMACPS_LENTYPE_ERR_OPTION |                   \
	 (uint32_t)XEMACPS_TRANSMITTER_ENABLE_OPTION |            \
	 (uint32_t)XEMACPS_RECEIVER_ENABLE_OPTION |               \
	 (uint32_t)XEMACPS_RX_CHKSUM_ENABLE_OPTION |              \
	 (uint32_t)XEMACPS_TX_CHKSUM_ENABLE_OPTION)
 ...
 *
 */
typedef void (*XEmacPs_ErrHandler) (void *CallBackRef, uint8_t Direction,
				    uint32_t ErrorWord);
...
#endif
	uint64_t BaseAddress;/**< Physical base address of IPIF registers */
	uint8_t IsCacheCoherent; /**< Applicable only to A53 in EL1 mode;
...
#endif
#if defined  (XCLOCKING)
	uint32_t RefClk;	/**< Input clock */
#endif
	uint16_t S1GDiv0;	/**< 1Gbps Clock Divider 0 */
	uint8_t S1GDiv1;	/**< 1Gbps Clock Divider 1 */
	uint16_t S100MDiv0;	/**< 100Mbps Clock Divider 0 */
	uint8_t S100MDiv1;	/**< 100Mbps Clock Divider 1 */
	uint16_t S10MDiv0;	/**< 10Mbps Clock Divider 0 */
	uint8_t S10MDiv1;	/**< 10Mbps Clock Divider 1 */
} XEmacPs_Config;
...
typedef struct XEmacPs_Instance {
	...
	uint32_t IsStarted;		/* Device is currently started */
	uint32_t IsReady;		/* Device is initialized and ready */
	uint32_t Options;		/* Current options word */
...
* C-style signature
*     void XEmacPs_IntEnable(XEmacPs *InstancePtr, uint32_t Mask)
*
*****************************************************************************/
...
* The state of the transmitter and receiver are not modified by this function.
* C-style signature
*     void XEmacPs_IntDisable(XEmacPs *InstancePtr, uint32_t Mask)
*
*****************************************************************************/
...
* The state of the transmitter and receiver are not modified by this function.
* C-style signature
*     void XEmacPs_IntQ1Enable(XEmacPs *InstancePtr, uint32_t Mask)
*
*****************************************************************************/
...
* @note
*
* Signature: uint32_t XEmacPs_IsRxCsum(XEmacPs *InstancePtr)
*
*****************************************************************************/
...
* @note
*
* Signature: uint32_t XEmacPs_IsTxCsum(XEmacPs *InstancePtr)
*
*****************************************************************************/
...
* @note
*
* Signature: void XEmacPs_SetRXWatermark(XEmacPs *InstancePtr, uint16_t High,
* 					uint16_t Low)
*
*****************************************************************************/
...
void XEmacPs_SetQueuePtr(XEmacPs *InstancePtr, uint64_t QPtr, uint8_t QueueNum,
			 uint16_t Direction);
 ...
 */
long XEmacPs_SetHandler(XEmacPs *InstancePtr, uint32_t HandlerType,
